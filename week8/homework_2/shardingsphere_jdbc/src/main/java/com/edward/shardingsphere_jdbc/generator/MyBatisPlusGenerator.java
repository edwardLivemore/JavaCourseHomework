package com.edward.shardingsphere_jdbc.generator;
...
/**
 * MyBatisPlus代码生成器
 * Created by eagle on 2020/8/20.
 */
public class MyBatisPlusGenerator {
//    public static final String outputPrefix = "/mybatis_generator";
    public static void main(String[] args) {
        String projectPath = System.getProperty("user.dir");
        String moduleName = scanner("modules");
        String[] tableNames = scanner("tables,please spilt with ','").split(",");
        // 代码生成器
